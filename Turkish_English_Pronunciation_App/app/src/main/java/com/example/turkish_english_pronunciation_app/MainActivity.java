...
public class MainActivity extends AppCompatActivity {
    ...
    public void changeActivity(View view){
        Intent intent = new Intent(MainActivity.this,Pronunciation.class);
        startActivity(intent);

    }

    public void changeActivity2(View view){
        Intent intent = new Intent(MainActivity.this,Pronunciation2.class);
        startActivity(intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        micIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Inside the onClick method for the microphone icon
                PackageManager packageManager = getPackageManager();
                if (i.resolveActivity(packageManager) != null) {
                    startActivityForResult(i, REQUEST_PERMISSION_CODE);
                } else {
                    Toast.makeText(MainActivity.this, "No app available to handle speech recognition.", Toast.LENGTH_SHORT).show();
                }
